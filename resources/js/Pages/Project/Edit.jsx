			...
			<div className="py-12">
				<div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
					<div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
						<div>
							<form className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg" action="" method="get" onSubmit={onSubmit}>
								{project.image_path && <div>
									<img src={project.image_path} className="w-64 mb-4" alt="" />
								</div>}
								<div>
									<InputLabel
